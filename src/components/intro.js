 ...
 return (
   <Container>
     <div className="main-text">
       Every year HackNotts gathers hundreds of hackers to engage with new
       technologies, engage with each other, and engage with the tech industry.
       Learn new skills, meet new people, and enjoy workshops and prizes from
       some great tech companies from Nottingham and beyond.
       <br />
       <br />
       ...
       corners, a <a href="https://twitter.com/BruceBernardII">giant bear</a>,
       and more.
     </div>
   </Container>
 )
